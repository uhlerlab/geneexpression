...
class CombinedDataset(Dataset):
    ...
    def get_MNIST(self):
        ...
        trainlabels_classes = []
        for idx in range(10):
            traindata_classes.append(mnist_data[mnist_labels==idx])
            trainlabels_classes.append(mnist_labels[mnist_labels==idx])
            print(mnist_data[mnist_labels==idx].shape)
...
#        trainlabels_2 = trainlabels_2[0:len(traindata_1)]
        ...
        return traindata_1, trainlabels_1
