...
CUDA_VISIBLE_DEVICES=1 python main.py -bs 509 -sd $savedir -iter 10000 -lamb0 0.01 -lamb1 0.1 -lamb2 0.01 -lambG2 1 -psi "JS" -citer 2 -lrG 0.1 -lrD 0.1 -env "nehaenv" > "${savedir}log.txt"
