...
CUDA_VISIBLE_DEVICES=1 python main.py -bs 509 -sd $savedir -iter 1000 -lamb0 0.01 -lamb1 0.1 -lamb2 0 -lambG2 0 -psi "JS" -citer 2 -lrG 0.0001 -lrD 0.0001 -env "nehaenv" > "${savedir}log.txt"
