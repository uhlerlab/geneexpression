...
CUDA_VISIBLE_DEVICES=1 python main.py -bs 128 -sd $savedir -iter 400 -lamb0 0.01 -lamb1 0.1 -lamb2 1 -lambG2 0.1 -psi "JS" -citer 2 -lrG 0.0001 -lrD 0.0001 -env "nehaenv" > "${savedir}log.txt"
