...
CUDA_VISIBLE_DEVICES=1 python conditional_main.py -bs 509 -sd $savedir -iter 100000 -lamb0 0.01 -lamb1 0.1 -lamb2 0.01 -lambG2 1 -psi "JS" -citer 2 -lrG 0.01 -lrD 0.005 -env "nehaenv" > "${savedir}log.txt"
